...
class App extends Component {
  ...
  setClicked = id => {
    ...
    if (clickedMatch[0].clicked) {
      ...
      this.setState({ clickMessage, correctGuesses, matches });
      ...
      this.setState({ matches, clickMessage, correctGuesses });
    } else {
      // Set its value to true
      clickedMatch[0].clicked = true;
  ...
  render() {
    return (
      <Wrapper>
        <Title>The Best that Dragonball Z Team You can Assemble!</Title>
